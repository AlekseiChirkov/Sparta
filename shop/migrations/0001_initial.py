...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('training_type', models.CharField(choices=[('Одноразовая тренировка', 'Одноразовая тренировка'), ('Тренировки с тренером', 'Тренировки с тренером'), ('Неделя с тренером', 'Неделя с тренером'), ('Самостоятельные тренировки', 'Самостоятельные тренировки')], max_length=64)),
                ('price', models.IntegerField()),
                ('description_1', models.CharField(blank=True, max_length=64, null=True)),
                ('description_2', models.CharField(blank=True, max_length=64, null=True)),
                ('description_3', models.CharField(blank=True, max_length=64, null=True)),
                ('description_4', models.CharField(blank=True, max_length=64, null=True)),
                ('description_5', models.CharField(blank=True, max_length=64, null=True)),
            ],
            options={
